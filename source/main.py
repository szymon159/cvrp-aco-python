...
def __get_heuristic_solver(number_of_trucks, s_max, test_set):
    return HeuristicSolver(test_set.cities, test_set.capacity, s_max, number_of_trucks, None)

def __get_aco_solver(number_of_trucks, s_max, test_set):
...
def __get_elitist_aco_solver(number_of_trucks, s_max, test_set):
...
def __get_enhanced_aco_solver(number_of_trucks, s_max, test_set):
